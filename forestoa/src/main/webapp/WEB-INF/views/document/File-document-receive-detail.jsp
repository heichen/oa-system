			...
			<div id="tab-system" class="HuiTab">
				...
				<a id="ui-toggle-1" href="#" style="margin-left: 25px;">审批流程</a>
					...
					<div id="dvBrand" class="row cl dvBrand "
						...
						<div class="row cl">
							...
							<label class="form-label col-xs-4 col-sm-2">来文文号:</label>
							<div class="formControls col-xs-8 col-sm-2 mt-5">
							...
							<div class="formControls col-xs-8 col-sm-2 mt-10" >
									...
									<input type="radio" disabled id="radio-1"
										 value="0" disabled > <label for="radio-1">10年</label>
									<input type="radio" disabled id="radio-1"
										 value="1" disabled > <label for="radio-1">30年</label>
									<input type="radio" disabled id="radio-1"
										 value="2" disabled > <label for="radio-1">永久</label>
								</div>
							</div>
						</div>
						<div class="row cl">
				...
				<!-- 	<div class="row cl handleBtn">
					...
					<div class="row cl handleBtn">
						...
						<div class="formControls col-xs-8 col-sm-10 pos-r mt-10">
				...
				<a id="ui-toggle-3" href="#" style="margin-left: 25px;">审批流程</a>
					...
					<div class="row cl">
						...
						<!-- <input type="text" readonly="readonly" class="input-text radius" id="searchfiletwo"> -->
						</div>
						<div class="formControls col-xs-8 col-sm-2 mt-5">
...
<script type="text/javascript">
	...
	<script type="text/javascript">
		...
		$("#saveBtn").click(function () {
			...
			btn_url = "documentReceive/saveReceive";
			receiveTasks = [];
		 	if(startNodeId==5){
				var menu = {
						"taskId" : taskId,
			...
			function save(data,fileIdArray) {
				layer.confirm('确认要提交吗？', function(index) {
					 $.ajaxFileUpload({
							url : ctx+"/documentReceive/saveReceive",
							secureuri : false,
		...
		function getHandle(taskId) {
			$.ajax({ url : 'documentReceive/getReceiveByTaskId',
						type : "POST",
						data : {
							"taskId" : taskId
						},
		...
		function getReceiveByTaskId(taskId) {
			$.ajax({
				url : 'documentReceive/getReceiveByTaskId',
				type : "POST",
				data : {
					"taskId" : taskId
				},
				...
				success : function(result) {
					if (result.success) {
				       ...
				       $("#searchfiletwo").text(result.data.POFILE);
		...
		function getReceiveByReceiveId(receiveId) {
			$.ajax({
						url : 'documentReceive/getReceiveByReceiveId',
						type : "POST",
						data : {
							"receiveId" : receiveId
						},
