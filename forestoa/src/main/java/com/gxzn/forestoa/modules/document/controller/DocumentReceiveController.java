...
@RestController
@CrossOrigin(origins = "*")
@RequestMapping("/documentReceive")
public class DocumentReceiveController {
	// 日志
	private Logger logger = LoggerFactory.getLogger(this.getClass());
	@Resource(name = "documentReceiveService")
	private DocumentReceiveService receiveService;
	...
	public ResponseModel<Long> saveReceive(DocumentReceive receive,@RequestParam("files") MultipartFile[] files) {
	 ...
	 * @return
	 */
	@RequestMapping(value = "deleteDocumentReceive")
	public ResponseModel<Long> deleteDocumentReceive(Long receiveId) {
		ResponseModel<Long> rm = new ResponseModel<Long>();
		try {
			receiveService.deleteDocumentReceive(receiveId);
