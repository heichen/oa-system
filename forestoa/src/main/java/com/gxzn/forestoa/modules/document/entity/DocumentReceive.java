...
public class DocumentReceive {
	...
	// 收文任务集合
	private List<DocumentReceiveTask> receiveTasks;
	...
	public List<DocumentReceiveTask> getReceiveTasks() {
		return receiveTasks;
	}

	public void setReceiveTasks(List<DocumentReceiveTask> receiveTasks) {
