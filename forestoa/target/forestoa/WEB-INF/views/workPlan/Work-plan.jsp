                ...
                }, */
                {
                    ...
                    "data":function(data) {
                        return  '<a onclick=product_show("工作计划查看",\''+ctx+'/Workplandetail\',"'+data.workplanId+'") class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe665;</i></a>'+
                            '<a onclick=product_edit("工作计划编辑",\''+ctx+'/Workplanedit\',"'+data.workplanId+'") class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>'+
                            '<a onclick=product_del("工作计划删除","'+data.workplanId+'") class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>';
                    }
                }
