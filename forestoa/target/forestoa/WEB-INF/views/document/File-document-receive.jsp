				...
				<form class="form form-horizontal" id="files-save" action="" method="post"
					...
					<div id="dvBrand" class="row cl" style="position: relative;">
						...
						<div id="ui-content-2">
							<div class="row cl">
								...
								<label class="form-label col-xs-4 col-sm-2 mt-10">来文文号:</label>
								<div class="formControls col-xs-8 col-sm-2 mt-5">
									<input type="text" class="input-text radius" value="" placeholder="请输入来文文号"
										id="NUMBER" name="number" aresrequired  aresmsg="来文文号不能为空">
								</div>
					...
					<div class="row cl" style="display:none">
						...
						<div class="formControls col-xs-8 col-sm-10">
							<textarea name="" id="OPINION" cols="" rows="" placeholder="请输入意见" class="textarea radius" required style="height:75px;"></textarea>
						</div>
					</div>
